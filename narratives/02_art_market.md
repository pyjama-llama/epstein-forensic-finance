...
*Source: DOJ EFTA Document Release, Deutsche Bank-SDNY Production, Exhibit D. All data extracted via automated pipeline. This finding appears in the [master wire ledger](../data/master_wire_ledger_phase25.json) published with this repository.*
