...
*This analysis queries every person entity in the EFTA corpus — 734,122 unique names extracted by NLP from 1.48 million documents — for co-occurrence across document categories. No names were pre-selected. The database determined who appears in both financial and victim-related records. See [COMPLIANCE.md](../COMPLIANCE.md) for professional standards framework.*

---

## The Question

The EFTA corpus contains 11.4 million entity extractions across 1.48 million DOJ documents. Of those, 734,122 are unique person-type entities. Most appear in one category of document. A few appear in two. A very small number appear in three.

I ran one query: show me every person who appears in at least 3 financial documents AND at least 3 victim-related documents. No name list. No search terms. The database decided.
...
| **Darren K. Indyke** | 196 | 204 | 176 | Estate attorney; co-signed wire transfers; named defendant in USVI victim lawsuit (EFTA00018778) |
...
Indyke and Kahn are the financial managers. They signed wire transfers (Narrative 1–6), appeared on travel documents, and were named as defendants in a 55-page USVI victim lawsuit (EFTA00018778) alongside Epstein — a court filing that references Little Saint James and uses Jane/John Doe plaintiff designations.

Groff is the scheduler. Documents in the corpus place her name in the same file as "Jane Doe" (EFTA00446172), "Victim Payouts" (EFTA00371439), and "the Federal Crime Victims Rights Act" (EFTA00429909). She managed the calendar.
